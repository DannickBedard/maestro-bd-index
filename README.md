...
FOUR (Supplier)
FOUCERTI (SupplierCertification)
...
MAGRPVTL (GroupAssignmentDocumentBreakdown)
...
WFROLE (Role)
WFACTIONS (WorkflowActionHistory)
VENDEUR (Salesperson)
